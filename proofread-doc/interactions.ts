...
export class ProofreadDocumentation extends InteractionBase<
  ProofreadDocumentationProps,
  ProofreadDocumentationResult
> {
  project = projectId;
...
export class GenerateInterfaceDoc extends InteractionBase<
  GenerateInterfaceDocProps,
  GenerateInterfaceDocResult
> {
  project = projectId;
  constructor(client?: StudioClient) {
...
export class UpdateAPIDocumentation extends InteractionBase<
  UpdateAPIDocumentationProps,
  UpdateAPIDocumentationResult
> {
  project = projectId;
  constructor(client?: StudioClient) {
